          ...
          <div :id=entry.id style="display:none">
            ...
            <button class="error-button" @click="visible2(entry.id+1000)">report an error</button>
              <div class="insight-answers">
                ...
                <div class="row">
                  <div v-for="(index) in 4" :key ="index">
                    <button class="answer-button">{{entry.answer[index-1].answer}}</button>
                    <!-- TODO: When user clicks on one answer, it gets submitted and all the other answer switch to label (not interactable)
                    <label class="answer-button">{{entry.answer[index-1].answer}} </label>
                    -->
                  </div>
                </div>
              </div>
              ...
              <p> Add value </p>
                ...
                <button class="submit-button" @click="submitUserInput">submit</button>
            </div>
          </div>
        </div>
